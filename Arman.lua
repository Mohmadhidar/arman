...
local res = https.request('https://tshake.ga/arman.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
...
os.execute('rm -rf arman.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/arman/arman/master/arman.lua', 'arman.lua') 
download_to_file('https://raw.githubusercontent.com/arman/arman/master/start.lua', 'start.lua') 
dofile('arman.lua')  
return false
end
...
Text = [[
🎁┇اهلا بك في سورس ارمان
- - - - - - - - - - - - - - - -
					
[🔱┋قناة السورس ارمان](https://t.me/HIDAARR)
					
[🛡┋گروب السورس] (t.me/DD441)
					
[💻┋مطور السورس] (t.me/DD444)
